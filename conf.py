...
BLOG_TITLE = "Interfectorem Lepus"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://necromuralist.github.io/Interfectorem-Lepus/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://necromuralist.github.io/Bowling-For-Data/"
BLOG_EMAIL = "cloisteredmonkey.jmark@slmail.me"
BLOG_DESCRIPTION = "A Monkey takes notes on rabbits."  # (translatable)
...
PAGES = (
    ("source/*.org", "pages", "page.tmpl"),
    ("source/*.rst", "pages", "page.tmpl"),
    ("source/*.md", "pages", "page.tmpl"),
    ("source/*.txt", "pages", "page.tmpl"),
    ("source/*.html", "pages", "page.tmpl"),
)
